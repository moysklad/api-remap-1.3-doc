...
```json
{
  ...
  "state" : "API_ERROR",
  "request": "https://online.moysklad.ru/api/remap/1.3/report/sales/plotseries?momentFrom=2018-09-06&interval=hour&async=true",
  "errors": [
      {
  ...
  "events": [
    {
      "meta": {
        "type": "async",
        "href": "https://online.moysklad.ru/api/remap/1.3/async/91adc76b-a71c-11eb-ac12-000e00000000"
      },
      "action": "PROCESSED",
      "accountId": "6c240ac7-a683-11eb-ac12-000c00000000"
    }
...
```shell
curl -X PUT
  "https://online.moysklad.ru/api/remap/1.3/async/498b8673-0308-11e6-9464-e4de00000089/cancel"
  -H "Authorization: Bearer <Access-Token>"
```

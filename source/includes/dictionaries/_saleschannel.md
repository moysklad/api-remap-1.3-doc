...
| ---------------- | :-------------------------------------------------------- | :--------------------------------------------------------------------------------------- | :---------------------- | :----------------------| :----|          
| **accountId**    | UUID                                                      | ID учетной записи<br>                                                                    | Только для чтения       | да                     | нет  
| **archived**     | Boolean                                                   | Добавлен ли Канал продаж в архив<br>                                                     | &mdash;                 | да                     | нет
| **code**         | String(255)                                               | Код Канала продаж                                                                        | &mdash;                 | нет                    | нет
| **description**  | String(4096)                                              | Описание Канала продаж                                                                   | &mdash;                 | нет                    | нет
| **externalCode** | String(255)                                               | Внешний код Канала продаж<br>                                                            | &mdash;                 | да                     | нет
| **group**        | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные отдела сотрудника<br>                                                         | &mdash;                 | да                     | да
| **id**           | UUID                                                      | ID Канала продаж<br>                                                                     | Только для чтения       | да                     | нет
| **meta**         | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные Канала продаж<br>                                                             | &mdash;                 | да                     | нет
| **name**         | String(255)                                               | Наименование Канала продаж<br>                                                           | Необходимое при создании| да                     | нет
| **owner**        | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные владельца (Сотрудника)<br>                                                    | &mdash;                 | нет                    | да
| **shared**       | Boolean                                                   | Общий доступ<br>                                                                         | &mdash;                 | да                     | нет
| **type**         | Enum                                                      | Тип Канала продаж [Подробнее тут](../dictionaries/#suschnosti-kanal-prodazh-kanaly-prodazh-tip-kanala-prodazh)<br> | Необходимое при создании| да | нет
| **updated**      | DateTime                                                  | Момент последнего обновления сущности<br>                                                | Только для чтения       | да                     | нет
...
```shell
curl -X GET
  "https://online.moysklad.ru/api/remap/1.3/entity/saleschannel"
...
```json
{
  ...
  "meta": {
    "href": "https://online.moysklad.ru/api/remap/1.3/entity/",
    "metadataHref": "https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/metadata",
    "type": "saleschannel",
    "mediaType": "application/json",
    "size": 2,
    "limit": 1000,
  ...
  "rows": [
    {
      "meta": {
        "href": "https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/51f263f9-0307-11e6-9464-e4de0000007c",
        "metadataHref": "https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/metadata",
        "type": "saleschannel",
        "mediaType": "application/json"
      },
    ...
    {
      "meta": {
        "href": "https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/8477d916-0aef-11e6-9464-e4de00000103",
        "metadataHref": "https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/metadata",
        "type": "saleschannel",
        "mediaType": "application/json"
      },
...
{
  "meta": {
    "href": "https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/53d1ff92-202b-11ec-0a82-050800000007",
    "metadataHref": "https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/metadata",
    "type": "saleschannel",
    "mediaType": "application/json",
  ...
  "owner": {
    "meta": {
      "href": "https://online.moysklad.ru/api/remap/1.3/entity/employee/4fe1932a-1d41-11ec-0a81-04b600001980",
      "metadataHref": "https://online.moysklad.ru/api/remap/1.3/entity/employee/metadata",
      "type": "employee",
      "mediaType": "application/json",
  ...
  "group": {
    "meta": {
      "href": "https://online.moysklad.ru/api/remap/1.3/entity/group/4fcbe1f2-1d41-11ec-0a82-06530000009f",
      "metadataHref": "https://online.moysklad.ru/api/remap/1.3/entity/group/metadata",
      "type": "group",
      "mediaType": "application/json"
    }
  ...
  curl -X POST
    ...
    -H "Content-Type: application/json"
      -d '[
            ...
            {
              "meta":{
                "href":"https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/da7a89fd-202b-11ec-0a82-05080000000a",
                "metadataHref":"https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/metadata",
                "type":"saleschannel",
                "mediaType":"application/json"
              },
...
[
  {
    "meta":{
      "href":"https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/286e7bd0-2032-11ec-9621-0242ac130002",
      "metadataHref":"https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/metadata",
      "type":"saleschannel",
      "mediaType":"application/json",
    ...
    "owner":{
      "meta":{
        "href":"https://online.moysklad.ru/api/remap/1.3/entity/employee/6c771d3c-2032-11ec-9621-0242ac130002",
        "metadataHref":"https://online.moysklad.ru/api/remap/1.3/entity/employee/metadata",
        "type":"employee",
        "mediaType":"application/json",
    ...
    "group":{
      "meta":{
        "href":"https://online.moysklad.ru/api/remap/1.3/entity/group/537bb8ec-2032-11ec-9621-0242ac130002",
        "metadataHref":"https://online.moysklad.ru/api/remap/1.3/entity/group/metadata",
        "type":"group",
        "mediaType":"application/json"
      }
  ...
  {
    "meta":{
      "href":"https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/5ca09f14-2032-11ec-9621-0242ac130002",
      "metadataHref":"https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/metadata",
      "type":"saleschannel",
      "mediaType":"application/json",
...
```shell
curl -X DELETE
  "https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/d94605a8-2033-11ec-9621-0242ac130002"
  -H "Authorization: Basic <Credentials>"
```
...
```shell
curl -X POST
  "https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/delete"
  -H "Authorization: Basic <Credentials>"
  -H "Content-Type: application/json"
  -d '[
        {
          "meta":{
            "href":"https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/fe8188dc-2034-11ec-9621-0242ac130002",
            "metadataHref":"https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/metadata",
            "type":"saleschannel",
            "mediaType":"application/json"
          }
        ...
        {
          "meta":{
            "href":"https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/0657ff6e-2035-11ec-9621-0242ac130002",
            "metadataHref":"https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/metadata",
            "type":"saleschannel",
            "mediaType":"application/json"
          }
...
{
  "meta": {
    "href": "https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/08624a82-2038-11ec-9621-0242ac130002",
    "metadataHref": "https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/metadata",
    "type": "saleschannel",
    "mediaType": "application/json",
...
```shell
  curl -X PUT
    "https://online.moysklad.ru/api/remap/1.3/entity/saleschannel/b2dc42f0-203e-11ec-9621-0242ac130002"
    -H "Authorization: Basic <Credentials>"
    -H "Content-Type: application/json"
      -d '{

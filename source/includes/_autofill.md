...
```shell
  curl -X POST
    "https://online.moysklad.ru/api/remap/1.3/autofill?fill=price"
...
```shell
  curl -X POST
    "https://online.moysklad.ru/api/remap/1.3/autofill?fill=discount"
    -H "Authorization: Basic <Credentials>"
    -H "Content-Type: application/json"
      -d '
{
...
```shell
  curl -X POST
    "https://online.moysklad.ru/api/remap/1.3/autofill?fill=vat"
    -H "Authorization: Basic <Credentials>"
    -H "Content-Type: application/json"
      -d '
{

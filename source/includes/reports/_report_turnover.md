...
```shell
curl -X GET
  "https://online.moysklad.ru/api/remap/1.3/report/turnover"
...
```json
{
    ...
    "meta": {
        "href": "https://online.moysklad.ru/api/remap/1.3/report/turnover",
        "type": "turnover",
        "mediaType": "application/json",
        "size": 3,
        "limit": 1000,
...
```shell
curl -X GET
  "https://online.moysklad.ru/api/remap/1.3/report/turnover/66990dc7-bdfe-11eb-c0a8-800c00000016"
  -H "Authorization: Basic <Credentials>"
```
...
```json
{
    ...
    "meta": {
        "href": "https://online.moysklad.ru/api/remap/1.3/report/turnover/66990dc7-bdfe-11eb-c0a8-800c00000016",
...
```shell
curl -X GET
  "https://online.moysklad.ru/api/remap/1.3/report/turnover/66990dc7-bdfe-11eb-c0a8-800c00000016/byoperations"
  -H "Authorization: Basic <Credentials>"
```
...
```json
{
  ...
  "meta": {
    "href": "https://online.moysklad.ru/api/remap/1.3/report/turnover/66990dc7-bdfe-11eb-c0a8-800c00000016/byoperations",

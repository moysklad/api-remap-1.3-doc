...
```shell
curl -X GET 
'https://online.moysklad.ru/api/remap/1.3/entity/product?order=name' 
-H 'Authorization: Bearer <Access-Token>' 
-H 'Cache-Control: no-cache'
```
...
```shell
curl -X GET 
'https://online.moysklad.ru/api/remap/1.3/entity/product?order=name,desc' 
-H 'Authorization: Bearer <Access-Token>' 
-H 'Cache-Control: no-cache'
```
...
```shell
curl -X GET 
'https://online.moysklad.ru/api/remap/1.3/entity/product?order=weighed,desc;name' 
-H 'Authorization: Bearer <Access-Token>' 
-H 'Cache-Control: no-cache' 
-H 'Content-Type: application/json'
```
...
```shell
curl -X GET 
'https://online.moysklad.ru/api/remap/1.3/entity/product?order=weighed,desc;weight,desc;name' 
-H 'Authorization: Bearer <Access-Token>' 
-H 'Cache-Control: no-cache' 
-H 'Content-Type: application/json'
```
...
```shell
curl -X GET 
'https://online.moysklad.ru/api/remap/1.3/entity/product?order=syncId' 
-H 'Authorization: Bearer <Access-Token>' 
-H 'Cache-Control: no-cache' 
-H 'Content-Type: application/json'
```

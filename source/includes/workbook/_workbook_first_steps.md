...
```json
{
    ...
    "meta": {
        ...
        "href": "https://online.moysklad.ru/api/remap/1.3/entity/product/a7404318-550f-11e8-56c0-000800000010"
    }
}
```
        ...
        "errors": [
            {
                ...
                "code": 3000,
                "parameter": "name",
                "moreInfo": "https://online.moysklad.ru/api/remap/1.3/doc#обработка-ошибок-3000",
                "line": 1,
                "column": 2
            }
        ]
...
Метаданные товара содержат ссылку на этот товар ("href":"https://online.moysklad.ru/api/remap/1.3/entity/product/a7404318-550f-11e8-56c0-000800000010") - ее можно использовать для запроса конкретно этого товара.
...
curl -X GET 
  -u login:password 
  -H "Lognex-Pretty-Print-JSON: true" 
  "https://online.moysklad.ru/api/remap/1.3/report/stock/all?stockMode=all"
```
    ...
    "rows": [
        {
            ...
            "meta": {
                ...
                "type": "product",
                "metadataHref": "https://online.moysklad.ru/api/remap/1.3/entity/product/metadata",
                "href": "https://online.moysklad.ru/api/remap/1.3/entity/product/a7404318-550f-11e8-56c0-000800000010?expand=supplier"
            }
        }
    ],
    "meta": {
        ...
        "mediaType": "application/json",
        "type": "stock",
        "href": "https://online.moysklad.ru/api/remap/1.3/report/stock/all?stockMode=all"
    },
    "context": {
        "employee": {
            "meta": {
...
curl -X GET 
  -u login:password 
  -H "Lognex-Pretty-Print-JSON: true" 
  "https://online.moysklad.ru/api/remap/1.3/entity/product?filter=name=%D0%9D%D0%BE%D0%B2%D0%BE%D0%B5%20%D0%BD%D0%B0%D0%B8%D0%BC%D0%B5%D0%BD%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5;updated%3E2018-01-01%2000:00:00"
```
...
```json
{
    ...
    "meta": {
        ...
        "mediaType": "application/json",
        "type": "product",
        "href": "https://online.moysklad.ru/api/remap/1.3/entity/product?filter=name=%D0%9D%D0%BE%D0%B2%D0%BE%D0%B5%20%D0%BD%D0%B0%D0%B8%D0%BC%D0%B5%D0%BD%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5;updated%3E2018-01-01%2000:00:00"
    },
    "context": {
        "employee": {
            "meta": {
...
```json
{
    ...
    "meta": {
        "nextHref": "https://online.moysklad.ru/api/remap/1.3/entity/country/?limit=25&offset=25",
        "offset": 0,
        "limit": 25,
        "size": 248,
        "mediaType": "application/json",
        "type": "country",
        "href": "https://online.moysklad.ru/api/remap/1.3/entity/country/"
    },
    "context": {
        "employee": {
            "meta": {
...
Метаданные коллекции содержат поле `"nextHref": "<https://online.moysklad.ru/api/remap/1.3/entity/country/?limit=25&offset=25>"`, данный запрос вернет следующую страницу данных.
...
curl -X GET 
  -u login:password 
  -H "Lognex-Pretty-Print-JSON: true" 
  "https://online.moysklad.ru/api/remap/1.3/entity/country/?limit=25&offset=25"
```
    ...
    "rows": [
        {
            ...
            "meta": {
                ...
                "type": "country",
                "metadataHref": "https://online.moysklad.ru/api/remap/1.3/entity/country/metadata",
                "href": "https://online.moysklad.ru/api/remap/1.3/entity/country/14a66b93-8edc-44fb-915a-61a63db190ed"
            }
        }
    ],
    "meta": {
        "previousHref": "https://online.moysklad.ru/api/remap/1.3/entity/country/?offset=0&limit=25",
        "nextHref": "https://online.moysklad.ru/api/remap/1.3/entity/country/?offset=50&limit=25",
        "offset": 25,
        "limit": 25,
        "size": 248,
        "mediaType": "application/json",
        "type": "country",
        "href": "https://online.moysklad.ru/api/remap/1.3/entity/country/?limit=25&offset=25"
    },
    "context": {
        "employee": {
            "meta": {
...
Теперь метаданные содержат оба поля `"nextHref": "https://online.moysklad.ru/api/remap/1.3/entity/country/?offset=50&limit=25", "previousHref": "<https://online.moysklad.ru/api/remap/1.3/entity/country/?offset=0&limit=25>"`. Эти запросы вернут следующую и предыдущую страницы соответственно.
...
curl -X GET 
  -u login:password 
  -H "Lognex-Pretty-Print-JSON: true" 
  "https://online.moysklad.ru/api/remap/1.3/entity/country/?search=%D0%BC%D0%B0%D1%80%D0%B8>"
```
    ...
    "rows": [
        {
            ...
            "meta": {
                ...
                "type": "country",
                "metadataHref": "https://online.moysklad.ru/api/remap/1.3/entity/country/metadata",
                "href": "https://online.moysklad.ru/api/remap/1.3/entity/country/34ad68f6-a8c6-4143-a7d9-7a9078f0e1e4"
            }
        },
        {
            "externalCode": "580",
            ...
            "meta": {
                ...
                "type": "country",
                "metadataHref": "https://online.moysklad.ru/api/remap/1.3/entity/country/metadata",
                "href": "https://online.moysklad.ru/api/remap/1.3/entity/country/9bb545bc-b467-43ee-bf25-32c20ce1d4aa"
            }
        }
    ],
    "meta": {
        ...
        "mediaType": "application/json",
        "type": "country",
        "href": "https://online.moysklad.ru/api/remap/1.3/entity/country/?search=%D0%BC%D0%B0%D1%80%D0%B8"
    },
    "context": {
        "employee": {
            "meta": {
...
curl -X GET 
  -u login:password 
  -H "Lognex-Pretty-Print-JSON: true" 
  "https://online.moysklad.ru/api/remap/1.3/entity/country/?order=name,desc;updated"
```
    ...
    "rows": [
        ...
        },
        {
            ...
            "meta": {
                ...
                "type": "country",
                "metadataHref": "https://online.moysklad.ru/api/remap/1.3/entity/country/metadata",
                "href": "https://online.moysklad.ru/api/remap/1.3/entity/country/886b465f-5bb0-4c6a-9b63-9abaf5157a26"
            }
        }
    ],
    "meta": {
        "nextHref": "https://online.moysklad.ru/api/remap/1.3/entity/country/?order=name%2Cdesc%3Bupdated&limit=25&offset=25",
        "offset": 0,
        "limit": 25,
        "size": 248,
        "mediaType": "application/json",
        "type": "country",
        "href": "https://online.moysklad.ru/api/remap/1.3/entity/country/?order=name,desc;updated"
    },
    "context": {
        "employee": {
            "meta": {
...
curl -X GET 
  -u login:password 
  -H "Lognex-Pretty-Print-JSON: true" 
  "https://online.moysklad.ru/api/remap/1.3/entity/product/a7404318-550f-11e8-56c0-000800000010?expand=owner,owner.group>"
```
...
```json
{
        ...
        "cashier": {
            "retailStore": {
                "meta": {
                    ...
                    "href": "https://online.moysklad.ru/api/remap/1.3/entity/retailstore/e3c30b43-2780-11e8-0532-9eed00000060"
                }
            },
            "employee": {
                "meta": {
    ...
    "meta": {
        ...
        "type": "product",
        "metadataHref": "https://online.moysklad.ru/api/remap/1.3/entity/product/metadata",
        "href": "https://online.moysklad.ru/api/remap/1.3/entity/product/a7404318-550f-11e8-56c0-000800000010?expand=owner"
    }
}
```

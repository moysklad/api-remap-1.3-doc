...
```json
{
  ...
  "href": "https://mskld.ru/fwVMObSLc9"
}
```
    ...
    "rows": [
        {
            ...
            "href": "https://mskld.ru/7cV5iVW0Zk"
        }
    ]
}
```
...
По ссылке публикации (например, https://mskld.ru/fHdm2AdqGk) открывается страница, с которой можно скачать pdf-документ. 

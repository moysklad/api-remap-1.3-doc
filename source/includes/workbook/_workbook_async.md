...
```shell
curl -X GET
  "https://online.moysklad.ru/api/remap/1.3/async?filter=state=done&deletionDate<2021-02-16 16:21:09"
  -H "Authorization: Bearer <Access-Token>"
```
...
```json
{
  ...
  "meta": {
    "href": "https://online.moysklad.ru/api/remap/1.3/async?filter=state=done;deletionDate%3C2021-02-16%2016:21:09",
    "type": "async",
    "mediaType": "application/json",
    "size": 2,
    "limit": 1000,
  ...
  "rows": [
    {
      "meta": {
        "href": "https://online.moysklad.ru/api/remap/1.3/async/baade4ee-a1d0-11eb-ac12-000b00000000",
        "type": "async",
        "mediaType": "application/json"
      },
      ...
      "owner": {
        "meta": {
          "href": "https://online.moysklad.ru/api/remap/1.3/entity/employee/4fe188f9-983a-11eb-0a80-39d600000034",
          "metadataHref": "https://online.moysklad.ru/api/remap/1.3/entity/employee/metadata",
          "type": "employee",
          "mediaType": "application/json",
      ...
      "state": "DONE",
      "request": "https://online.moysklad.ru/api/remap/1.3/report/stock/all?async=true",
      "resultUrl": "https://online.moysklad.ru/api/remap/1.3/async/baade4ee-a1d0-11eb-ac12-000b00000000/result",
      "deletionDate": "2021-04-16 16:07:13.027"
    },
    {
      "meta": {
        "href": "https://online.moysklad.ru/api/remap/1.3/async/d2bfbf9f-a1e0-11eb-ac12-000b00000000",
        "type": "async",
        "mediaType": "application/json"
      },
      ...
      "state": "DONE",
      "request": "https://online.moysklad.ru/api/remap/1.3/report/stock/bystore?async=true",
      "resultUrl": "https://online.moysklad.ru/api/remap/1.3/async/d2bfbf9f-a1e0-11eb-ac12-000b00000000/result",
...
Для того, чтобы не опрашивать эндпоинт статуса выполняемой асинхронной задачи можно настроить [вебхук](https://dev.moysklad.ru/doc/api/remap/1.3/dictionaries/#suschnosti-veb-huki) на оповещение, когда задача будет завершена.
...
{
    "meta": {
        "href": "https://online.moysklad.ru/api/remap/1.3/entity/webhook/c6010bf9-a683-11eb-ac12-000900000001",

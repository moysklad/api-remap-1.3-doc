...
`https://online.moysklad.ru/api/remap/1.3/entity/<ключевое слово для документа>/template`
<br>
В тело POST запроса по данному ресурсу нужно передать метаданные документа, на основе которого будет создан шаблон нового документа, либо просто передать пустое тело запроса.
...
| Розничная продажа (retaildemand)                     | Розничная смена, Заказ покупателя             |
 ...
 В результате POST запроса по /entity/entityName/template НЕ будет создано нового документа.  
...
+ **search**
  ...
  + Примеры запросов контекстного поиска (значения должны быть urlencoded):
    - `https://online.moysklad.ru/api/remap/1.3/entity/retaildemand?search=100`
    - `https://online.moysklad.ru/api/remap/1.3/entity/salesreturn?search=брак`
    - `https://online.moysklad.ru/api/remap/1.3/entity/retailshift?search=ночная`
...
```shell
  curl -X POST
    "https://online.moysklad.ru/api/remap/1.3/entity/supply/be3a3a0e-370c-11e7-1542-821d00000001/trash"
...
```shell
  curl -X PUT
    "PUT https://online.moysklad.ru/api/remap/1.3/entity/move/7944ef04-f831-11e5-7a69-971500188b19"
    -H "Authorization: Basic <Credentials>"
    -H "Content-Type: application/json"
      -d '{
            "internalOrder": {
...
{
  "meta": {
    "href": "https://online.moysklad.ru/api/remap/1.3/entity/move/d9318341-b0da-11e6-8a84-bae5000000c7",
  ...
  "positions": {
    "meta": {
      "href": "https://online.moysklad.ru/api/remap/1.3/entity/move/d9318341-b0da-11e6-8a84-bae5000000c7/positions",
      "type": "moveposition",
      "mediaType": "application/json",
      "size": 1,
      "limit": 1000,
  ...
  "targetStore": {
    "meta": {
      "href": "https://online.moysklad.ru/api/remap/1.3/entity/store/85a8e439-b0d8-11e6-8a84-bae500000070",
      "metadataHref": "https://online.moysklad.ru/api/remap/1.3/entity/store/metadata",
      "type": "store",
      "mediaType": "application/json"
    }
...
```json
{
  ...
  "positions": {
    "meta": {
      "href": "https://online.moysklad.ru/api/remap/1.3/entity/demand/06406b97-9138-11e6-8a84-bae500000000/positions",
      "type": "demandposition",
      "mediaType": "application/json",
      "size": 1,
      "limit": 1000,
...
{
  "meta": {
    "href": "https://online.moysklad.ru/api/remap/1.3/entity/paymentin/94a9f8e9-b30b-11e6-8a84-bae500000017",
  ...
  "organization": {
    "meta": {
      "href": "https://online.moysklad.ru/api/remap/1.3/entity/organization/a8f3150d-9d39-11e6-8a84-bae500000074",
      "metadataHref": "https://online.moysklad.ru/api/remap/1.3/entity/organization/metadata",
      "type": "organization",
      "mediaType": "application/json"
    }
...
{
  "meta": {
    "href": "https://online.moysklad.ru/api/remap/1.3/entity/cashin/834d731c-b313-11e6-8a84-bae50000008e",

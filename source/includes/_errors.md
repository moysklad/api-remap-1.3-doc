...
|<a name="error_63002">63002</a>|Ошибка применения сохраненного фильтра: неверный формат ссылки на сохраненный фильтр|Корректный формат ссылки должен иметь тип [URL](https://dev.moysklad.ru/doc/api/remap/1.3/#mojsklad-json-api-obschie-swedeniq-tipy-dannyh)

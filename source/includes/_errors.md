...
|<a name="error_63002">63001</a>|Ошибка применения сохраненного фильтра: неверный формат ссылки на фильтр|Корректный формат ссылки должен иметь тип [URL](https://dev.moysklad.ru/doc/api/remap/1.3/#mojsklad-json-api-obschie-swedeniq-tipy-dannyh)
|<a name="error_63003">63002</a>|Ошибка применения сохраненного фильтра: указанный фильтр не предназначен для применения к типу сущности в ссылке|Тип сущности, указанный в ссылке, не соответствует применяемому ресурсу

...
| Код ошибки                      | Сообщение                                                                                  | Описание                                                                                              |
| ------------------------------- | ------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------- |
| <a name="error_64000">64000</a> | Ошибка: вы не можете изменить тип для Канала продаж, созданного автоматически              | Канал продаж созданный автоматически имеет неизменяемый тип, доступный только для чтения              |

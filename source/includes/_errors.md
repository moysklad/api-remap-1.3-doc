...
|<a name="error_63001">63001</a>|Ошибка применения сохраненного фильтра: сохраненный фильтр не совместим с любой другой фильтрацией|Сохраненный и стандартные фильтры можно применять только по отдельности
|<a name="error_63002">63002</a>|Ошибка применения сохраненного фильтра: указанный фильтр не совместим с текущим эндпоинтом|Тип сущностей, для которых был создан фильтр, отличается от типа ресурса, на котором идет применение
|<a name="error_63003">63003</a>|Ошибка применения сохраненного фильтра: неверный формат ссылки на фильтр|Формат значения параметра запроса не соответствует ожидаемому
|<a name="error_63004">63004</a>|Ошибка применения сохраненного фильтра: указанный фильтр не предназначен для применения к типу сущности в ссылке|Ссылка в параметре запроса ведет на ресурс, несоответствующий текущему
|<a name="error_63005">63005</a>|Ошибка применения сохраненного фильтра: допускается одновременное применение только одного сохраненного фильтра|Применение нескольких сохраненных фильтров в одном запросе не поддерживается

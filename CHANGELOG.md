...
## 28-07-2021
### Добавлено
- Новый заголовок управления временем жизни ссылок на скачивание изображений и файловв. Описание в [общих сведениях](https://dev.moysklad.ru/doc/api/remap/1.3/#mojsklad-json-api-obschie-swedeniq-ssylki-na-fajly)

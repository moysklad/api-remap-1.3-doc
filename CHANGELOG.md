...
## 19-20-2021
### Добавлено
- Новый заголовок управления временем жизни конечных ссылок на скачивание файлов [В общих сведениях](https://dev.moysklad.ru/doc/api/remap/1.3/#mojsklad-json-api-obschie-swedeniq-ssylki-na-fajly)

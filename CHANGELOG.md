...
## XX-XX-2021
### Изменено
- Исправлена валидация дат в фильтрах запросов. При передаче даты, которая меньше чем 1970 год - отправляется ошибка [1035](https://dev.moysklad.ru/doc/api/remap/1.3/#mojsklad-json-api-oshibki)
